...
# ── path setup ────────────────────────────────────────────────────────────────
HERE     = Path(__file__).resolve().parent   # igraph_version/data/
ROOT_DIR = HERE.parent                       # igraph_version/
for _p in (str(ROOT_DIR), str(ROOT_DIR / "simclr")):
...
def main():
    ...
    out_path = Path(args.out) if args.out else ROOT_DIR / "results" / "elliptic" / "visualize_elliptic.png"
